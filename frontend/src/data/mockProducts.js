...
export const categories = [
  ...
  { id: 'c5', slug: 'snacks', name: 'Snacks', icon: '🍿' },
  { id: 'c6', slug: 'dairy', name: 'Dairy', icon: '🥛' },
  { id: 'c7', slug: 'vegetables', name: 'Vegetables', icon: '🥬' },
  { id: 'c8', slug: 'beverages', name: 'Beverages', icon: '☕' },
  ...
  { id: 'c14', slug: 'biscuits', name: 'Biscuits', icon: '🍪' },
  { id: 'c15', slug: 'home-cleaner', name: 'Home Cleaner', icon: '🧽' },
  { id: 'c16', slug: 'napkins', name: 'Napkins', icon: '🧻' },
  { id: 'c17', slug: 'detergent-oil', name: 'Detergent Oil', icon: '🧴' },
  { id: 'c18', slug: 'soap', name: 'Soap', icon: '🧼' },
  { id: 'c19', slug: 'shampoo', name: 'Shampoo', icon: '🧴' },
  { id: 'c20', slug: 'paste-brush', name: 'Paste & Brush', icon: '🪥' },
  { id: 'c21', slug: 'maavu', name: 'Maavu', icon: '🌾' },
];
